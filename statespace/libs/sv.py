...
# sample endog
np.random.seed(1234)
endog = pd.Series(np.random.normal(0,0.1,200)).cumsum() + pd.Series(np.random.normal(0,0.01,200)) + 1
...
pd.DataFrame((np.exp(0.5*posterior_states[1]))).join(pd.Series(endog,name='endog')).plot()